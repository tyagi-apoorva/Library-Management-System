...
<body>
	<!-- _________________________side nav_______________________________-->
...
function closeNav() {
  ...
  document.body.style.backgroundColor = "white";
    ...
    <!-- _______________________search bar__________________________________-->
    <div class="srch">
	...
	<!-- ____________________Request Book____________________________________-->
	<div class="srch">
        <form class = "navbar-form" method = "post" name = "form1">
			...
			else
			{
				?>
					<div class="alert alert-danger" style="width: 600px; margin-left: 370px; background-color: #de1313; color: white">
            			<strong>You need to login to Request a Book</strong>
          			</div> 
				<?php
			}
